...
import { FundingMethod } from './FundingWizard';

interface FundingMethodStepProps {
    selected: FundingMethod;
    onSelect: (method: FundingMethod) => void;
}

const FundingMethodStep: React.FC<FundingMethodStepProps> = ({ selected, onSelect }) => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            >
                ...
                <div className="space-y-2 mb-8">
                    <h3 className="text-xl font-black text-slate-950 tracking-tight">Bank Transfer</h3>
                    <p className="text-xs text-slate-500 font-medium leading-relaxed">
                        Authorize institutional Wire or ACH transfers. Traditional fiat settlement for high-value onboarding.
                    </p>
                </div>

                <div className="w-full flex items-center justify-between pt-6 border-t border-slate-50">
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">USD Onboarding</span>
            ...
            >
                ...
                <div className="space-y-2 mb-8">
                    <h3 className="text-xl font-black text-slate-950 tracking-tight">Digital Assets</h3>
                    <p className="text-xs text-slate-500 font-medium leading-relaxed">
                        Instant stablecoin or crypto settlement. Secure transfer via Ethereum, Solana, and other primary networks.
                    </p>
                </div>

                <div className="w-full flex items-center justify-between pt-6 border-t border-slate-50">
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">Stablecoin / BTC / ETH</span>
...
export default FundingMethodStep;
