                    ...
                    <div className="lg:col-span-2 space-y-10">
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                            <div className="flex items-center gap-8">
                                <div className="w-24 h-24 bg-white rounded-[2rem] border border-slate-100 shadow-sm flex items-center justify-center p-4 overflow-hidden">
                        ...
                        {/* Chart Container */}
                        <div className="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm flex flex-col h-[600px] relative overflow-hidden">
                                ...
                                {isChartLoading ? (
                                    <div className="absolute inset-0 flex items-center justify-center bg-slate-50/50 rounded-3xl border border-dashed border-slate-100">
                                        <div className="flex flex-col items-center gap-4">
                                            ...
                                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Synchronizing Liquidity Feeds...</span>
                                        </div>
                                    </div>
                                ) : (
                                    <>
                                        <StockChart data={chartData} />
                                        <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-white via-white/90 to-transparent pt-10 text-center">
                                            <div className="flex items-center justify-center gap-3 text-slate-400">
                                                <Building2 className="w-4 h-4" />
                                                <p className="text-[9px] font-bold uppercase tracking-widest leading-relaxed max-w-md">
                                                    Institutional data feed secured. Real-time execution via Fornix Prime Liquidity Network.
                                                </p>
                                            </div>
                                        </div>
                                    </>
